...
class EndToEndTest:
    ...
    def step_impl(context):
        ...
        elementProductPrice = wait.until(EC.presence_of_element_located((By.CLASS_NAME, "price")))
        ...
        # Add selected option size to Global context
        ...
        print("---------------------------------------------------------------------------")
        # print(elementSizeDiv.text)
        print(context.productSize)
        print(context.productColor)
    ...
    def step_impl(context):
        raise NotImplementedError(u'STEP: Then I Makesure the Product In Stock')

    @when(u'I Choose Size, Color, and Quantity the Product')
    def step_impl(context):
        raise NotImplementedError(u'STEP: When I Choose Size, Color, and Quantity the Product')

    @when(u'I Click Add to Cart button')
    def step_impl(context):
        raise NotImplementedError(u'STEP: When I Click Add to Cart button')

    @then(u'The Product Success Added to Shopping Cart')
    def step_impl(context):
        raise NotImplementedError(u'STEP: Then The Product Success Added to Shopping Cart')
